...
void print_joy_data(Joy_msg joy) {
	std::cout << "====joyDATA====" << std::endl
		<< "yaw: \t" << joy.axes[0] << std::endl
		<< "yaw: \t" << joy.axes[1] << std::endl
		<< "yaw: \t" << joy.axes[2] << std::endl
		<< "yaw: \t" << joy.axes[3] << std::endl
		<< "yaw: \t" << joy.axes[4] << std::endl
		<< "yaw: \t" << joy.axes[5] << std::endl
		<< "yaw: \t" << joy.axes[6] << std::endl
		<< "yaw: \t" << joy.axes[7] << std::endl
		<< "pitch: \t" << joy.buttons[0] << std::endl
		<< "pitch: \t" << joy.buttons[1] << std::endl
		<< "pitch: \t" << joy.buttons[2] << std::endl
		<< "pitch: \t" << joy.buttons[3] << std::endl
		<< "pitch: \t" << joy.buttons[4] << std::endl
		<< "pitch: \t" << joy.buttons[5] << std::endl
		<< "pitch: \t" << joy.buttons[6] << std::endl
		<< "pitch: \t" << joy.buttons[7] << std::endl
		<< "pitch: \t" << joy.buttons[8] << std::endl
		<< "pitch: \t" << joy.buttons[9] << std::endl
		<< "pitch: \t" << joy.buttons[10] << std::endl
		<< "pitch: \t" << joy.buttons[11] << std::endl
		<< "pitch: \t" << joy.buttons[12] << std::endl
		<< "pitch: \t" << joy.buttons[13] << std::endl;
...
class BridgeClass {
	public:
		...
		Joy_msg attempt_get_non_blocking() {
			// Clear The Buffer
			...
			switch (current_state) {
				case START_BYTE_FOUND:
					...
					std::memcpy(&(Buffer.axes), DataBufferFromLib.data(), sizeof(Buffer) - sizeof(Buffer.start_byte)); //
